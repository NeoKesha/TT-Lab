...
namespace TT_Lab.Assets.Instance
{
    ...
    {
        public Path(String package, String subpackage, UInt32 id, String name, String chunk, Int32 layId, PS2AnyPath path) : base(package, subpackage, id, name, chunk, layId)
        {
