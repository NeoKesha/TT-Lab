...
public class Affine3 : TransformBaseReal {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(Affine3 obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public Matrix4 __mul__(Matrix4 m) {
    Matrix4 ret = new Matrix4(OgrePINVOKE.Affine3___mul____SWIG_3(swigCPtr, Matrix4.getCPtr(m)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
