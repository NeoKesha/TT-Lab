...
public class ApplicationContext : ApplicationContextBase {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(ApplicationContext obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  protected virtual new void _destroyWindow(NativeWindowPair win) {
    if (SwigDerivedClassHasMethod("_destroyWindow", swigMethodTypes24)) BitesPINVOKE.ApplicationContext__destroyWindowSwigExplicitApplicationContext(swigCPtr, NativeWindowPair.getCPtr(win)); else BitesPINVOKE.ApplicationContext__destroyWindow(swigCPtr, NativeWindowPair.getCPtr(win));
  ...
  public override void setWindowGrab(SWIGTYPE_p_SDL_Window win) {
    if (SwigDerivedClassHasMethod("setWindowGrab", swigMethodTypes12)) BitesPINVOKE.ApplicationContext_setWindowGrabSwigExplicitApplicationContext__SWIG_1(swigCPtr, SWIGTYPE_p_SDL_Window.getCPtr(win)); else BitesPINVOKE.ApplicationContext_setWindowGrab__SWIG_1(swigCPtr, SWIGTYPE_p_SDL_Window.getCPtr(win));
    if (BitesPINVOKE.SWIGPendingException.Pending) throw BitesPINVOKE.SWIGPendingException.Retrieve();
  }

  public new void setWindowGrab(bool grab) {
    BitesPINVOKE.ApplicationContext_setWindowGrab__SWIG_2(swigCPtr, grab);
    if (BitesPINVOKE.SWIGPendingException.Pending) throw BitesPINVOKE.SWIGPendingException.Retrieve();
  }

  public new void setWindowGrab() {
    BitesPINVOKE.ApplicationContext_setWindowGrab__SWIG_3(swigCPtr);
    if (BitesPINVOKE.SWIGPendingException.Pending) throw BitesPINVOKE.SWIGPendingException.Retrieve();
  }

  public new void addInputListener(InputListener lis) {
    BitesPINVOKE.ApplicationContext_addInputListener__SWIG_1(swigCPtr, InputListener.getCPtr(lis));
    if (BitesPINVOKE.SWIGPendingException.Pending) throw BitesPINVOKE.SWIGPendingException.Retrieve();
  }

  public new void removeInputListener(InputListener lis) {
    BitesPINVOKE.ApplicationContext_removeInputListener__SWIG_1(swigCPtr, InputListener.getCPtr(lis));
    if (BitesPINVOKE.SWIGPendingException.Pending) throw BitesPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    if (SwigDerivedClassHasMethod("setWindowGrab", swigMethodTypes12))
      swigDelegate12 = new SwigDelegateApplicationContext_12(SwigDirectorMethodsetWindowGrab__SWIG_1);
    ...
    if (SwigDerivedClassHasMethod("shutdown", swigMethodTypes16))
      swigDelegate16 = new SwigDelegateApplicationContext_16(SwigDirectorMethodshutdown);
    if (SwigDerivedClassHasMethod("pollEvents", swigMethodTypes17))
      swigDelegate17 = new SwigDelegateApplicationContext_17(SwigDirectorMethodpollEvents);
    if (SwigDerivedClassHasMethod("addInputListener", swigMethodTypes18))
      swigDelegate18 = new SwigDelegateApplicationContext_18(SwigDirectorMethodaddInputListener__SWIG_0);
    if (SwigDerivedClassHasMethod("removeInputListener", swigMethodTypes19))
      swigDelegate19 = new SwigDelegateApplicationContext_19(SwigDirectorMethodremoveInputListener__SWIG_0);
    if (SwigDerivedClassHasMethod("createWindow", swigMethodTypes20))
      swigDelegate20 = new SwigDelegateApplicationContext_20(SwigDirectorMethodcreateWindow__SWIG_0);
    if (SwigDerivedClassHasMethod("createWindow", swigMethodTypes21))
      swigDelegate21 = new SwigDelegateApplicationContext_21(SwigDirectorMethodcreateWindow__SWIG_1);
    if (SwigDerivedClassHasMethod("createWindow", swigMethodTypes22))
      swigDelegate22 = new SwigDelegateApplicationContext_22(SwigDirectorMethodcreateWindow__SWIG_2);
    if (SwigDerivedClassHasMethod("createWindow", swigMethodTypes23))
      swigDelegate23 = new SwigDelegateApplicationContext_23(SwigDirectorMethodcreateWindow__SWIG_3);
    if (SwigDerivedClassHasMethod("_destroyWindow", swigMethodTypes24))
      swigDelegate24 = new SwigDelegateApplicationContext_24(SwigDirectorMethod_destroyWindow);
  ...
  private bool SwigDerivedClassHasMethod(string methodName, global::System.Type[] methodTypes) {
    ...
    foreach (global::System.Reflection.MethodInfo methodInfo in methodInfos) {
      ...
      if (methodInfo.IsVirtual && (methodInfo.DeclaringType.IsSubclassOf(typeof(ApplicationContext))) &&
  ...
  public delegate void SwigDelegateApplicationContext_24(global::System.IntPtr win);
  ...
  private static global::System.Type[] swigMethodTypes20 = new global::System.Type[] { typeof(string), typeof(uint), typeof(uint), typeof(NameValueMap) };
  ...
  private static global::System.Type[] swigMethodTypes24 = new global::System.Type[] { typeof(NativeWindowPair) };
}
