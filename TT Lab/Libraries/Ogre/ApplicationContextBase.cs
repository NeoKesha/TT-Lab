...
public class ApplicationContextBase : FrameListener {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(ApplicationContextBase obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public OverlaySystem getOverlaySystem() {
  ...
  public void runRenderingSettingsDialog() {
    BitesPINVOKE.ApplicationContextBase_runRenderingSettingsDialog(swigCPtr);
    if (BitesPINVOKE.SWIGPendingException.Pending) throw BitesPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public ImGuiOverlay initialiseImGui() {
    global::System.IntPtr cPtr = BitesPINVOKE.ApplicationContextBase_initialiseImGui(swigCPtr);
    ImGuiOverlay ret = (cPtr == global::System.IntPtr.Zero) ? null : new ImGuiOverlay(cPtr, false);
    if (BitesPINVOKE.SWIGPendingException.Pending) throw BitesPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public InputListener getImGuiInputListener() {
    global::System.IntPtr cPtr = BitesPINVOKE.ApplicationContextBase_getImGuiInputListener(swigCPtr);
  ...
  protected virtual void _destroyWindow(NativeWindowPair win) {
    if (SwigDerivedClassHasMethod("_destroyWindow", swigMethodTypes24)) BitesPINVOKE.ApplicationContextBase__destroyWindowSwigExplicitApplicationContextBase(swigCPtr, NativeWindowPair.getCPtr(win)); else BitesPINVOKE.ApplicationContextBase__destroyWindow(swigCPtr, NativeWindowPair.getCPtr(win));
    if (BitesPINVOKE.SWIGPendingException.Pending) throw BitesPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    if (SwigDerivedClassHasMethod("shutdown", swigMethodTypes16))
      swigDelegate16 = new SwigDelegateApplicationContextBase_16(SwigDirectorMethodshutdown);
    if (SwigDerivedClassHasMethod("pollEvents", swigMethodTypes17))
      swigDelegate17 = new SwigDelegateApplicationContextBase_17(SwigDirectorMethodpollEvents);
    if (SwigDerivedClassHasMethod("addInputListener", swigMethodTypes18))
      swigDelegate18 = new SwigDelegateApplicationContextBase_18(SwigDirectorMethodaddInputListener__SWIG_0);
    if (SwigDerivedClassHasMethod("removeInputListener", swigMethodTypes19))
      swigDelegate19 = new SwigDelegateApplicationContextBase_19(SwigDirectorMethodremoveInputListener__SWIG_0);
    if (SwigDerivedClassHasMethod("createWindow", swigMethodTypes20))
      swigDelegate20 = new SwigDelegateApplicationContextBase_20(SwigDirectorMethodcreateWindow__SWIG_0);
    if (SwigDerivedClassHasMethod("createWindow", swigMethodTypes21))
      swigDelegate21 = new SwigDelegateApplicationContextBase_21(SwigDirectorMethodcreateWindow__SWIG_1);
    if (SwigDerivedClassHasMethod("createWindow", swigMethodTypes22))
      swigDelegate22 = new SwigDelegateApplicationContextBase_22(SwigDirectorMethodcreateWindow__SWIG_2);
    if (SwigDerivedClassHasMethod("createWindow", swigMethodTypes23))
      swigDelegate23 = new SwigDelegateApplicationContextBase_23(SwigDirectorMethodcreateWindow__SWIG_3);
    if (SwigDerivedClassHasMethod("_destroyWindow", swigMethodTypes24))
      swigDelegate24 = new SwigDelegateApplicationContextBase_24(SwigDirectorMethod_destroyWindow);
  ...
  private bool SwigDerivedClassHasMethod(string methodName, global::System.Type[] methodTypes) {
    ...
    foreach (global::System.Reflection.MethodInfo methodInfo in methodInfos) {
      ...
      if (methodInfo.IsVirtual && (methodInfo.DeclaringType.IsSubclassOf(typeof(ApplicationContextBase))) &&
  ...
  public delegate void SwigDelegateApplicationContextBase_24(global::System.IntPtr win);
