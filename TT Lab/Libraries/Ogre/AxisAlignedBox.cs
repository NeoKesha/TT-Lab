...
public class AxisAlignedBox : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(AxisAlignedBox obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public SWIGTYPE_p_std__arrayT_Ogre__VectorT_3_Ogre__Real_t_8_t getAllCorners() {
    SWIGTYPE_p_std__arrayT_Ogre__VectorT_3_Ogre__Real_t_8_t ret = new SWIGTYPE_p_std__arrayT_Ogre__VectorT_3_Ogre__Real_t_8_t(OgrePINVOKE.AxisAlignedBox_getAllCorners(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
