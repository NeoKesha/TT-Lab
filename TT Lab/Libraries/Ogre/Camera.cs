...
public class Camera : Frustum {
  ...
  public override SWIGTYPE_p_a_8__Ogre__VectorT_3_Ogre__Real_t getWorldSpaceCorners() {
    SWIGTYPE_p_a_8__Ogre__VectorT_3_Ogre__Real_t ret = new SWIGTYPE_p_a_8__Ogre__VectorT_3_Ogre__Real_t(OgrePINVOKE.Camera_getWorldSpaceCorners(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public override float getNearClipDistance() {
  ...
  public override Affine3 getViewMatrix() {
