...
public class EmbeddedZipArchiveFactory : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(EmbeddedZipArchiveFactory obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public EmbeddedZipArchiveFactory() : this(OgrePINVOKE.new_EmbeddedZipArchiveFactory(), true) {
  ...
  public Archive createInstance(string name) {
    global::System.IntPtr cPtr = OgrePINVOKE.EmbeddedZipArchiveFactory_createInstance__SWIG_0(swigCPtr, name);
  ...
  public Archive createInstance(string name, bool readOnly) {
    global::System.IntPtr cPtr = OgrePINVOKE.EmbeddedZipArchiveFactory_createInstance__SWIG_1(swigCPtr, name, readOnly);
    Archive ret = (cPtr == global::System.IntPtr.Zero) ? null : new Archive(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
