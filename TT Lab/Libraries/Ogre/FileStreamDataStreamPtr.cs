...
public class FileStreamDataStreamPtr : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(FileStreamDataStreamPtr obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public FileStreamDataStreamPtr(FileStreamDataStream underlyingClass) : this(OgrePINVOKE.new_FileStreamDataStreamPtr__SWIG_3(FileStreamDataStream.getCPtr(underlyingClass)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
