...
public class Frustum : MovableObject {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(Frustum obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public virtual float getNearClipDistance() {
  ...
  public virtual float getFarClipDistance() {
  ...
  public virtual Affine3 getViewMatrix() {
  ...
  public override bool isVisible() {
    bool ret = OgrePINVOKE.Frustum_isVisible__SWIG_0(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual SWIGTYPE_p_a_8__Ogre__VectorT_3_Ogre__Real_t getWorldSpaceCorners() {
    SWIGTYPE_p_a_8__Ogre__VectorT_3_Ogre__Real_t ret = new SWIGTYPE_p_a_8__Ogre__VectorT_3_Ogre__Real_t(OgrePINVOKE.Frustum_getWorldSpaceCorners(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
