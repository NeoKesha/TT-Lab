...
public class GpuProgramParameters : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(GpuProgramParameters obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public class AutoConstantDefinition : global::System.IDisposable {
    ...
    internal static global::System.Runtime.InteropServices.HandleRef swigRelease(AutoConstantDefinition obj) {
      if (obj != null) {
        if (!obj.swigCMemOwn)
          throw new global::System.ApplicationException("Cannot release ownership as memory is not owned");
        global::System.Runtime.InteropServices.HandleRef ptr = obj.swigCPtr;
  ...
  public class AutoConstantEntry : global::System.IDisposable {
    ...
    internal static global::System.Runtime.InteropServices.HandleRef swigRelease(AutoConstantEntry obj) {
      if (obj != null) {
        if (!obj.swigCMemOwn)
          throw new global::System.ApplicationException("Cannot release ownership as memory is not owned");
        global::System.Runtime.InteropServices.HandleRef ptr = obj.swigCPtr;
  ...
  public void _writeRawConstant(uint physicalIndex, Matrix4 m, uint elementCount) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_0(swigCPtr, physicalIndex, Matrix4.getCPtr(m), elementCount);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, Matrix3 m, uint elementCount) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_1(swigCPtr, physicalIndex, Matrix3.getCPtr(m), elementCount);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, TransformBaseReal m, uint numEntries) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_2(swigCPtr, physicalIndex, TransformBaseReal.getCPtr(m), numEntries);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, ColourValue colour, uint count) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_3(swigCPtr, physicalIndex, ColourValue.getCPtr(colour), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, ColourValue colour) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_4(swigCPtr, physicalIndex, ColourValue.getCPtr(colour));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
