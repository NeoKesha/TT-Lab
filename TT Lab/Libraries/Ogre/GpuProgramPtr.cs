...
public class GpuProgramPtr : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(GpuProgramPtr obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public GpuProgramPtr(GpuProgram underlyingClass) : this(OgrePINVOKE.new_GpuProgramPtr__SWIG_3(GpuProgram.getCPtr(underlyingClass)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
