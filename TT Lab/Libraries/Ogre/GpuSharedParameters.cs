...
public class GpuSharedParameters : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(GpuSharedParameters obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void setNamedConstant(string name, Matrix4 m) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_0(swigCPtr, name, Matrix4.getCPtr(m));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setNamedConstant(string name, Matrix4 m, uint numEntries) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_1(swigCPtr, name, Matrix4.getCPtr(m), numEntries);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setNamedConstant(string name, SWIGTYPE_p_float val, uint count) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_2(swigCPtr, name, SWIGTYPE_p_float.getCPtr(val), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setNamedConstant(string name, SWIGTYPE_p_double val, uint count) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_3(swigCPtr, name, SWIGTYPE_p_double.getCPtr(val), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setNamedConstant(string name, ColourValue colour) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_4(swigCPtr, name, ColourValue.getCPtr(colour));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setNamedConstant(string name, SWIGTYPE_p_int val, uint count) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_5(swigCPtr, name, SWIGTYPE_p_int.getCPtr(val), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setNamedConstant(string name, SWIGTYPE_p_unsigned_int val, uint count) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_6(swigCPtr, name, SWIGTYPE_p_unsigned_int.getCPtr(val), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
