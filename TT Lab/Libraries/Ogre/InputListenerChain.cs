...
public class InputListenerChain : InputListener {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(InputListenerChain obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public bool empty() {
    bool ret = BitesPINVOKE.InputListenerChain_empty(swigCPtr);
    if (BitesPINVOKE.SWIGPendingException.Pending) throw BitesPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override void frameRendered(FrameEvent evt) {
    BitesPINVOKE.InputListenerChain_frameRendered(swigCPtr, FrameEvent.getCPtr(evt));
    if (BitesPINVOKE.SWIGPendingException.Pending) throw BitesPINVOKE.SWIGPendingException.Retrieve();
  }
