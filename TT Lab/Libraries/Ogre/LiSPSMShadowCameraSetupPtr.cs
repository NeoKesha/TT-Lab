...
public class LiSPSMShadowCameraSetupPtr : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(LiSPSMShadowCameraSetupPtr obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public LiSPSMShadowCameraSetupPtr(LiSPSMShadowCameraSetup underlyingClass) : this(OgrePINVOKE.new_LiSPSMShadowCameraSetupPtr__SWIG_3(LiSPSMShadowCameraSetup.getCPtr(underlyingClass)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
