...
public class ManualObject : MovableObject {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(ManualObject obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public class ManualObjectSection : Renderable {
    ...
    internal static global::System.Runtime.InteropServices.HandleRef swigRelease(ManualObjectSection obj) {
      if (obj != null) {
        if (!obj.swigCMemOwn)
          throw new global::System.ApplicationException("Cannot release ownership as memory is not owned");
        global::System.Runtime.InteropServices.HandleRef ptr = obj.swigCPtr;
