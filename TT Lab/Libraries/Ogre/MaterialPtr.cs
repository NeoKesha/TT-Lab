...
public class MaterialPtr : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(MaterialPtr obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public MaterialPtr(Material underlyingClass) : this(OgrePINVOKE.new_MaterialPtr__SWIG_3(Material.getCPtr(underlyingClass)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
