...
public class Math : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(Math obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public class RandomValueProvider : global::System.IDisposable {
    ...
    internal static global::System.Runtime.InteropServices.HandleRef swigRelease(RandomValueProvider obj) {
      if (obj != null) {
        if (!obj.swigCMemOwn)
          throw new global::System.ApplicationException("Cannot release ownership as memory is not owned");
        global::System.Runtime.InteropServices.HandleRef ptr = obj.swigCPtr;
