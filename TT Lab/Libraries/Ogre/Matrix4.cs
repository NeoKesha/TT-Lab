...
public class Matrix4 : TransformBaseReal {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(Matrix4 obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public Matrix4(Matrix3 m3x3) : this(OgrePINVOKE.new_Matrix4__SWIG_3(Matrix3.getCPtr(m3x3)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public Matrix4(Quaternion rot) : this(OgrePINVOKE.new_Matrix4__SWIG_4(Quaternion.getCPtr(rot)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public Matrix4 __mul__(Affine3 m) {
    Matrix4 ret = new Matrix4(OgrePINVOKE.Matrix4___mul____SWIG_4(swigCPtr, Affine3.getCPtr(m)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
