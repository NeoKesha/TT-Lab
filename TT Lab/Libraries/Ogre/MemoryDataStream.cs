...
public class MemoryDataStream : DataStream {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(MemoryDataStream obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public MemoryDataStream(DataStream sourceStream, bool freeOnClose, bool readOnly) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_6(DataStream.getCPtr(sourceStream), freeOnClose, readOnly), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(DataStream sourceStream, bool freeOnClose) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_7(DataStream.getCPtr(sourceStream), freeOnClose), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(DataStream sourceStream) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_8(DataStream.getCPtr(sourceStream)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(DataStreamPtr sourceStream, bool freeOnClose, bool readOnly) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_9(DataStreamPtr.getCPtr(sourceStream), freeOnClose, readOnly), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(DataStreamPtr sourceStream, bool freeOnClose) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_10(DataStreamPtr.getCPtr(sourceStream), freeOnClose), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(DataStreamPtr sourceStream) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_11(DataStreamPtr.getCPtr(sourceStream)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(string name, DataStreamPtr sourceStream, bool freeOnClose, bool readOnly) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_12(name, DataStreamPtr.getCPtr(sourceStream), freeOnClose, readOnly), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(string name, DataStreamPtr sourceStream, bool freeOnClose) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_13(name, DataStreamPtr.getCPtr(sourceStream), freeOnClose), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(string name, DataStreamPtr sourceStream) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_14(name, DataStreamPtr.getCPtr(sourceStream)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(uint size, bool freeOnClose, bool readOnly) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_15(size, freeOnClose, readOnly), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(uint size, bool freeOnClose) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_16(size, freeOnClose), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(uint size) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_17(size), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(string name, uint size, bool freeOnClose, bool readOnly) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_18(name, size, freeOnClose, readOnly), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(string name, uint size, bool freeOnClose) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_19(name, size, freeOnClose), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(string name, uint size) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_20(name, size), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
