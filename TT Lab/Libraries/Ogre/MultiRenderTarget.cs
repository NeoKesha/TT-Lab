...
public class MultiRenderTarget : RenderTarget {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(MultiRenderTarget obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public override void copyContentsToMemory(Box src, PixelBox dst, RenderTarget.FrameBuffer buffer) {
    OgrePINVOKE.MultiRenderTarget_copyContentsToMemory__SWIG_0(swigCPtr, Box.getCPtr(src), PixelBox.getCPtr(dst), (int)buffer);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public override void copyContentsToMemory(Box src, PixelBox dst) {
    OgrePINVOKE.MultiRenderTarget_copyContentsToMemory__SWIG_1(swigCPtr, Box.getCPtr(src), PixelBox.getCPtr(dst));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
