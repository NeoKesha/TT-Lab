...
public class Ogre {
  ...
  public static string MOT_FRUSTUM {
    get {
      string ret = OgrePINVOKE.MOT_FRUSTUM_get();
      if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
  ...
  public static Vector3i __mul__(float s, Vector3i v) {
    Vector3i ret = new Vector3i(OgrePINVOKE.__mul____SWIG_3(s, Vector3i.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector3i __add__(float s, Vector3i v) {
    Vector3i ret = new Vector3i(OgrePINVOKE.__add____SWIG_1(s, Vector3i.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector3i __sub__(float s, Vector3i v) {
    Vector3i ret = new Vector3i(OgrePINVOKE.__sub____SWIG_1(s, Vector3i.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector3i __div__(float s, Vector3i v) {
    Vector3i ret = new Vector3i(OgrePINVOKE.__div____SWIG_3(s, Vector3i.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector2 __mul__(float s, Vector2 v) {
    Vector2 ret = new Vector2(OgrePINVOKE.__mul____SWIG_4(s, Vector2.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector2 __add__(float s, Vector2 v) {
    Vector2 ret = new Vector2(OgrePINVOKE.__add____SWIG_2(s, Vector2.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector2 __sub__(float s, Vector2 v) {
    Vector2 ret = new Vector2(OgrePINVOKE.__sub____SWIG_2(s, Vector2.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector2 __div__(float s, Vector2 v) {
    Vector2 ret = new Vector2(OgrePINVOKE.__div____SWIG_4(s, Vector2.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector3 __mul__(float s, Vector3 v) {
    Vector3 ret = new Vector3(OgrePINVOKE.__mul____SWIG_5(s, Vector3.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector3 __add__(float s, Vector3 v) {
    Vector3 ret = new Vector3(OgrePINVOKE.__add____SWIG_3(s, Vector3.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector3 __sub__(float s, Vector3 v) {
    Vector3 ret = new Vector3(OgrePINVOKE.__sub____SWIG_3(s, Vector3.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector3 __div__(float s, Vector3 v) {
    Vector3 ret = new Vector3(OgrePINVOKE.__div____SWIG_5(s, Vector3.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector4 __mul__(float s, Vector4 v) {
    Vector4 ret = new Vector4(OgrePINVOKE.__mul____SWIG_6(s, Vector4.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector4 __add__(float s, Vector4 v) {
    Vector4 ret = new Vector4(OgrePINVOKE.__add____SWIG_4(s, Vector4.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector4 __sub__(float s, Vector4 v) {
    Vector4 ret = new Vector4(OgrePINVOKE.__sub____SWIG_4(s, Vector4.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector4 __div__(float s, Vector4 v) {
    Vector4 ret = new Vector4(OgrePINVOKE.__div____SWIG_6(s, Vector4.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector3 __mul__(Vector3 rkVector, Matrix3 rkMatrix) {
    Vector3 ret = new Vector3(OgrePINVOKE.__mul____SWIG_7(Vector3.getCPtr(rkVector), Matrix3.getCPtr(rkMatrix)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Matrix3 __mul__(float fScalar, Matrix3 rkMatrix) {
    Matrix3 ret = new Matrix3(OgrePINVOKE.__mul____SWIG_8(fScalar, Matrix3.getCPtr(rkMatrix)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector3 __mul__(Matrix3 m, Vector3 v) {
    Vector3 ret = new Vector3(OgrePINVOKE.__mul____SWIG_9(Matrix3.getCPtr(m), Vector3.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Matrix4 __mul__(Matrix4 m, Matrix4 m2) {
    Matrix4 ret = new Matrix4(OgrePINVOKE.__mul____SWIG_10(Matrix4.getCPtr(m), Matrix4.getCPtr(m2)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Matrix4 __add__(Matrix4 m, Matrix4 m2) {
    Matrix4 ret = new Matrix4(OgrePINVOKE.__add____SWIG_5(Matrix4.getCPtr(m), Matrix4.getCPtr(m2)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Matrix4 __sub__(Matrix4 m, Matrix4 m2) {
    Matrix4 ret = new Matrix4(OgrePINVOKE.__sub____SWIG_5(Matrix4.getCPtr(m), Matrix4.getCPtr(m2)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Affine3 __mul__(Affine3 m, Affine3 m2) {
    Affine3 ret = new Affine3(OgrePINVOKE.__mul____SWIG_11(Affine3.getCPtr(m), Affine3.getCPtr(m2)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector3 __mul__(Matrix4 m, Vector3 v) {
    Vector3 ret = new Vector3(OgrePINVOKE.__mul____SWIG_12(Matrix4.getCPtr(m), Vector3.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector3 __mul__(Affine3 m, Vector3 v) {
    Vector3 ret = new Vector3(OgrePINVOKE.__mul____SWIG_13(Affine3.getCPtr(m), Vector3.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector4 __mul__(Matrix4 m, Vector4 v) {
    Vector4 ret = new Vector4(OgrePINVOKE.__mul____SWIG_14(Matrix4.getCPtr(m), Vector4.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector4 __mul__(Affine3 m, Vector4 v) {
    Vector4 ret = new Vector4(OgrePINVOKE.__mul____SWIG_15(Affine3.getCPtr(m), Vector4.getCPtr(v)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Vector4 __mul__(Vector4 v, Matrix4 mat) {
    Vector4 ret = new Vector4(OgrePINVOKE.__mul____SWIG_16(Vector4.getCPtr(v), Matrix4.getCPtr(mat)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Quaternion __mul__(float s, Quaternion q) {
    Quaternion ret = new Quaternion(OgrePINVOKE.__mul____SWIG_17(s, Quaternion.getCPtr(q)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static Plane __mul__(Matrix4 mat, Plane p) {
    Plane ret = new Plane(OgrePINVOKE.__mul____SWIG_18(Matrix4.getCPtr(mat), Plane.getCPtr(p)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static ColourValue __mul__(float fScalar, ColourValue rkVector) {
    ColourValue ret = new ColourValue(OgrePINVOKE.__mul____SWIG_19(fScalar, ColourValue.getCPtr(rkVector)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static readonly int GPT_PIPELINE_COUNT = OgrePINVOKE.GPT_PIPELINE_COUNT_get();
  ...
  public static readonly int ID_MESH_PROGRAM = OgrePINVOKE.ID_MESH_PROGRAM_get();
  public static readonly int ID_MESH_PROGRAM_REF = OgrePINVOKE.ID_MESH_PROGRAM_REF_get();
  public static readonly int ID_TASK_PROGRAM = OgrePINVOKE.ID_TASK_PROGRAM_get();
  public static readonly int ID_TASK_PROGRAM_REF = OgrePINVOKE.ID_TASK_PROGRAM_REF_get();
  public static readonly int ID_FSAA = OgrePINVOKE.ID_FSAA_get();
