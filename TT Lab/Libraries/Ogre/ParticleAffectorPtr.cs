...
public class ParticleAffectorPtr : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(ParticleAffectorPtr obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public ParticleAffectorPtr(ParticleAffector underlyingClass) : this(OgrePINVOKE.new_ParticleAffectorPtr__SWIG_3(ParticleAffector.getCPtr(underlyingClass)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
