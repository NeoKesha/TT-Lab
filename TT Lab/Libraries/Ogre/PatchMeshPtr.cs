...
public class PatchMeshPtr : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(PatchMeshPtr obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public PatchMeshPtr(PatchMesh underlyingClass) : this(OgrePINVOKE.new_PatchMeshPtr__SWIG_3(PatchMesh.getCPtr(underlyingClass)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public bool suggestTangentVectorBuildParams(out ushort outSourceCoordSet) {
    bool ret = OgrePINVOKE.PatchMeshPtr_suggestTangentVectorBuildParams(swigCPtr, out outSourceCoordSet);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
