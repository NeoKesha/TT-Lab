...
public class PixelUtil : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(PixelUtil obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public static void unpackColour(SWIGTYPE_p_float r, SWIGTYPE_p_float g, SWIGTYPE_p_float b, SWIGTYPE_p_float a, PixelFormat pf, global::System.IntPtr src) {
    OgrePINVOKE.PixelUtil_unpackColour__SWIG_1(SWIGTYPE_p_float.getCPtr(r), SWIGTYPE_p_float.getCPtr(g), SWIGTYPE_p_float.getCPtr(b), SWIGTYPE_p_float.getCPtr(a), (int)pf, src);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public static void unpackColour(SWIGTYPE_p_unsigned_char r, SWIGTYPE_p_unsigned_char g, SWIGTYPE_p_unsigned_char b, SWIGTYPE_p_unsigned_char a, PixelFormat pf, global::System.IntPtr src) {
    OgrePINVOKE.PixelUtil_unpackColour__SWIG_2(SWIGTYPE_p_unsigned_char.getCPtr(r), SWIGTYPE_p_unsigned_char.getCPtr(g), SWIGTYPE_p_unsigned_char.getCPtr(b), SWIGTYPE_p_unsigned_char.getCPtr(a), (int)pf, src);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
