...
public class PlaneOptimalShadowCameraSetupPtr : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(PlaneOptimalShadowCameraSetupPtr obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public PlaneOptimalShadowCameraSetupPtr(PlaneOptimalShadowCameraSetup underlyingClass) : this(OgrePINVOKE.new_PlaneOptimalShadowCameraSetupPtr__SWIG_3(PlaneOptimalShadowCameraSetup.getCPtr(underlyingClass)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
