...
public class RenderSystem : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(RenderSystem obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public virtual void getCustomAttribute(string name, out global::System.IntPtr pData) {
    OgrePINVOKE.RenderSystem_getCustomAttribute(swigCPtr, name, out pData);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
