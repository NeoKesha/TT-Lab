...
public class RenderTarget : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(RenderTarget obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public virtual void getCustomAttribute(string name, out global::System.IntPtr pData) {
    OgrePINVOKE.RenderTarget_getCustomAttribute__SWIG_0(swigCPtr, name, out pData);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
