...
public class ShadowCameraSetupPtr : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(ShadowCameraSetupPtr obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public ShadowCameraSetupPtr(ShadowCameraSetup underlyingClass) : this(OgrePINVOKE.new_ShadowCameraSetupPtr__SWIG_3(ShadowCameraSetup.getCPtr(underlyingClass)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
