...
public class SkeletonInstancePtr : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(SkeletonInstancePtr obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public SkeletonInstancePtr(SkeletonInstance underlyingClass) : this(OgrePINVOKE.new_SkeletonInstancePtr__SWIG_3(SkeletonInstance.getCPtr(underlyingClass)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
