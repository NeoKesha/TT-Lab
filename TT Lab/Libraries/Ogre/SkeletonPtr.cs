...
public class SkeletonPtr : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(SkeletonPtr obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public SkeletonPtr(Skeleton underlyingClass) : this(OgrePINVOKE.new_SkeletonPtr__SWIG_3(Skeleton.getCPtr(underlyingClass)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
