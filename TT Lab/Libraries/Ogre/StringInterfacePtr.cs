...
public class StringInterfacePtr : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(StringInterfacePtr obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public StringInterfacePtr(StringInterface underlyingClass) : this(OgrePINVOKE.new_StringInterfacePtr__SWIG_3(StringInterface.getCPtr(underlyingClass)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
