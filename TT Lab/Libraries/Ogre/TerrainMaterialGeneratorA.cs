...
public class TerrainMaterialGeneratorA : TerrainMaterialGenerator {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(TerrainMaterialGeneratorA obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public class SM2Profile : TerrainMaterialGenerator.Profile {
    ...
    internal static global::System.Runtime.InteropServices.HandleRef swigRelease(SM2Profile obj) {
      if (obj != null) {
        if (!obj.swigCMemOwn)
          throw new global::System.ApplicationException("Cannot release ownership as memory is not owned");
        global::System.Runtime.InteropServices.HandleRef ptr = obj.swigCPtr;
