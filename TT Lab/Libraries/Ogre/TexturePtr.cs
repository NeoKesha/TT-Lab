...
public class TexturePtr : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(TexturePtr obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public TexturePtr(Texture underlyingClass) : this(OgrePINVOKE.new_TexturePtr__SWIG_3(Texture.getCPtr(underlyingClass)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
