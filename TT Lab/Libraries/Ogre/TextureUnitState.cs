...
public class TextureUnitState : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(TextureUnitState obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public class TextureEffect : global::System.IDisposable {
    ...
    internal static global::System.Runtime.InteropServices.HandleRef swigRelease(TextureEffect obj) {
      if (obj != null) {
        if (!obj.swigCMemOwn)
          throw new global::System.ApplicationException("Cannot release ownership as memory is not owned");
        global::System.Runtime.InteropServices.HandleRef ptr = obj.swigCPtr;
  ...
  public void setAnimatedTextureName(StringList names, float duration) {
    OgrePINVOKE.TextureUnitState_setAnimatedTextureName__SWIG_2(swigCPtr, StringList.getCPtr(names), duration);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setAnimatedTextureName(StringList names) {
    OgrePINVOKE.TextureUnitState_setAnimatedTextureName__SWIG_3(swigCPtr, StringList.getCPtr(names));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void setEnvironmentMap(bool enable, int texGenType) {
    OgrePINVOKE.TextureUnitState_setEnvironmentMap__SWIG_0(swigCPtr, enable, texGenType);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public Frustum getProjectiveTexturingFrustum() {
    global::System.IntPtr cPtr = OgrePINVOKE.TextureUnitState_getProjectiveTexturingFrustum(swigCPtr);
    Frustum ret = (cPtr == global::System.IntPtr.Zero) ? null : new Frustum(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
