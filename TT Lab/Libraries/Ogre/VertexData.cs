...
public class VertexData : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(VertexData obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public class HardwareAnimationData : global::System.IDisposable {
    ...
    internal static global::System.Runtime.InteropServices.HandleRef swigRelease(HardwareAnimationData obj) {
      if (obj != null) {
        if (!obj.swigCMemOwn)
          throw new global::System.ApplicationException("Cannot release ownership as memory is not owned");
        global::System.Runtime.InteropServices.HandleRef ptr = obj.swigCPtr;
  ...
  public void convertVertexElement(VertexElementSemantic semantic, VertexElementType dstType, ushort index) {
    OgrePINVOKE.VertexData_convertVertexElement__SWIG_0(swigCPtr, (int)semantic, (int)dstType, index);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void convertVertexElement(VertexElementSemantic semantic, VertexElementType dstType) {
    OgrePINVOKE.VertexData_convertVertexElement__SWIG_1(swigCPtr, (int)semantic, (int)dstType);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
