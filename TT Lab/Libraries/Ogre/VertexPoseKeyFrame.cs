...
public class VertexPoseKeyFrame : KeyFrame {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(VertexPoseKeyFrame obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public class PoseRef : global::System.IDisposable {
    ...
    internal static global::System.Runtime.InteropServices.HandleRef swigRelease(PoseRef obj) {
      if (obj != null) {
        if (!obj.swigCMemOwn)
          throw new global::System.ApplicationException("Cannot release ownership as memory is not owned");
        global::System.Runtime.InteropServices.HandleRef ptr = obj.swigCPtr;
