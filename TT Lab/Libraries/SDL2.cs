...
{
    /// <summary>
    /// SDL2 support, mostly for keyboard inputs conversions to SDL
    /// </summary>
    public class SDL2
    {
        ...
        /// <returns></returns>
        public static int WpfKeyToSdlKey(KeyEventArgs keyEvent)
        {
            switch (keyEvent.Key)
            {
                case Key.None:
                    return (int)SDL_Keycode.SDLK_UNKNOWN;
                case Key.Cancel:
                    return (int)SDL_Keycode.SDLK_CANCEL;
                case Key.Back:
                    return (int)SDL_Keycode.SDLK_BACKSPACE;
                case Key.Tab:
                    return (int)SDL_Keycode.SDLK_TAB;
                case Key.Clear:
                    break;
                case Key.Enter:
                    return (int)SDL_Keycode.SDLK_RETURN;
                case Key.Pause:
                    return (int)SDL_Keycode.SDLK_PAUSE;
                case Key.Capital:
                    return (int)SDL_Keycode.SDLK_CAPSLOCK;
                case Key.Escape:
                    return (int)SDL_Keycode.SDLK_ESCAPE;
                case Key.Space:
                    return (int)SDL_Keycode.SDLK_SPACE;
                case Key.PageUp:
                    return (int)SDL_Keycode.SDLK_PAGEUP;
                case Key.PageDown:
                    return (int)SDL_Keycode.SDLK_PAGEDOWN;
                case Key.End:
                    return (int)SDL_Keycode.SDLK_END;
                case Key.Home:
                    return (int)SDL_Keycode.SDLK_HOME;
                case Key.Left:
                    return (int)SDL_Keycode.SDLK_LEFT;
                case Key.Up:
                    return (int)SDL_Keycode.SDLK_UP;
                case Key.Right:
                    return (int)SDL_Keycode.SDLK_RIGHT;
                case Key.Down:
                    return (int)SDL_Keycode.SDLK_DOWN;
                case Key.Select:
                    return (int)SDL_Keycode.SDLK_SELECT;
                case Key.PrintScreen:
                    return (int)SDL_Keycode.SDLK_PRINTSCREEN;
                case Key.Insert:
                    return (int)SDL_Keycode.SDLK_INSERT;
                case Key.Delete:
                    return (int)SDL_Keycode.SDLK_DELETE;
                case Key.Help:
                    return (int)SDL_Keycode.SDLK_HELP;
                case Key.A:
                case Key.S:
                case Key.B:
                case Key.C:
                ...
                case Key.Y:
                case Key.Z:
                    return keyEvent.Key.ToString().ToLower()[0];
                case Key.NumPad0:
                    return (int)SDL_Keycode.SDLK_KP_0;
                case Key.NumPad1:
                    return (int)SDL_Keycode.SDLK_KP_1;
                case Key.NumPad2:
                    return (int)SDL_Keycode.SDLK_KP_2;
                case Key.NumPad3:
                    return (int)SDL_Keycode.SDLK_KP_3;
                case Key.NumPad4:
                    return (int)SDL_Keycode.SDLK_KP_4;
                case Key.NumPad5:
                    return (int)SDL_Keycode.SDLK_KP_5;
                case Key.NumPad6:
                    return (int)SDL_Keycode.SDLK_KP_6;
                case Key.NumPad7:
                    return (int)SDL_Keycode.SDLK_KP_7;
                case Key.NumPad8:
                    return (int)SDL_Keycode.SDLK_KP_8;
                case Key.NumPad9:
                    return (int)SDL_Keycode.SDLK_KP_9;
                case Key.Multiply:
                    return (int)SDL_Keycode.SDLK_KP_MULTIPLY;
                case Key.Add:
                    return (int)SDL_Keycode.SDLK_KP_PLUS;
                case Key.Separator:
                    return (int)SDL_Keycode.SDLK_SEPARATOR;
                case Key.Subtract:
                    return (int)SDL_Keycode.SDLK_KP_MINUS;
                case Key.Decimal:
                    return (int)SDL_Keycode.SDLK_KP_DECIMAL;
                case Key.Divide:
                    return (int)SDL_Keycode.SDLK_KP_DIVIDE;
                case Key.F1:
                    return (int)SDL_Keycode.SDLK_F1;
                case Key.F2:
                    return (int)SDL_Keycode.SDLK_F2;
                case Key.F3:
                    return (int)SDL_Keycode.SDLK_F3;
                case Key.F4:
                    return (int)SDL_Keycode.SDLK_F4;
                case Key.F5:
                    return (int)SDL_Keycode.SDLK_F5;
                case Key.F6:
                    return (int)SDL_Keycode.SDLK_F6;
                case Key.F7:
                    return (int)SDL_Keycode.SDLK_F7;
                case Key.F8:
                    return (int)SDL_Keycode.SDLK_F8;
                case Key.F9:
                    return (int)SDL_Keycode.SDLK_F9;
                case Key.F10:
                    return (int)SDL_Keycode.SDLK_F10;
                case Key.F11:
                    return (int)SDL_Keycode.SDLK_F11;
                case Key.F12:
                    return (int)SDL_Keycode.SDLK_F12;
                case Key.F13:
                    return (int)SDL_Keycode.SDLK_F13;
                case Key.LeftShift:
                    return (int)SDL_Keycode.SDLK_LSHIFT;
                case Key.RightShift:
                    return (int)SDL_Keycode.SDLK_RSHIFT;
                case Key.LeftCtrl:
                    return (int)SDL_Keycode.SDLK_LCTRL;
                case Key.RightCtrl:
                    return (int)SDL_Keycode.SDLK_RCTRL;
                case Key.LeftAlt:
                    return (int)SDL_Keycode.SDLK_LALT;
                case Key.RightAlt:
                    return (int)SDL_Keycode.SDLK_RALT;
            }
