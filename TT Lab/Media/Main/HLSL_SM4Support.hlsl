...
float4 texelFetch(Sampler1D s, int v, int lod) { return s.t.Load(int2(v, lod)); }
float4 texelFetch(Sampler2D s, int2 v, int lod) { return s.t.Load(int3(v.x, v.y, lod)); }
float4 texelFetch(Sampler3D s, int3 v, int lod) { return s.t.Load(int4(v.x, v.y, v.z, lod)); }
