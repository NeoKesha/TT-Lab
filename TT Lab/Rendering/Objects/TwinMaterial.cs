...
namespace TT_Lab.Rendering.Objects
{
    public class TwinMaterial
    {
        ...
        public TwinMaterial(string textureUniformName, Bitmap bitmap, ShaderViewModel viewModel, int texUnitPos, int uniIndex = -1)
        {
            //GL = gl;
        ...
        public void Bind()
        {
            //if (uniIndex != -1)
            //{
            //    _shader.SetTextureUniform($"{_texName}[{uniIndex}]", TbTextureTarget.Texture2D, _texture.Buffer, (uint)texUnitPos);
            ...
            //else
            //{
            //    _shader.SetTextureUniform($"{_texName}", TbTextureTarget.Texture2D, _texture.Buffer, (uint)texUnitPos);
